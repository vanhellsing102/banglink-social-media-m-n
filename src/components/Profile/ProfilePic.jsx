...
const ProfilePic = () => {
    ...
    const {profileImage, refetch} = useGetCurrentUserProfilePicture();
    ...
    return (
        <div className='flex justify-between'>
            <div className='relative'>
                <Image className='border-2 border-blue-500 p-1 rounded-full h-[200px] w-[200px]' width={300} height={300} alt='profile pic' src={profileImage ? profileImage : "/images/profile.avif"}></Image>
